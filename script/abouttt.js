...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Gunakan warna yang sudah Anda tentukan (misalnya Biru Cerah)
    const activeColor = '#1E90FF'; 
    const inactiveColor = '#555'; // Warna abu-abu default
    ...
    function generateCommentHtml(nama, rating, komentar) {
        ...
        // Tambahkan highlight sementara agar mudah dilihat
        newReview.style.boxShadow = `0 0 25px rgba(30,144,255,0.45)`; 
        newReview.style.borderLeft = `5px solid ${activeColor}`; 
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.success) {
                ...
                // 4. Hapus highlight setelah beberapa detik
                setTimeout(() => {
                    newComment.style.boxShadow = 'none';
                    newComment.style.borderLeft = 'none';
                }, 5000); 
